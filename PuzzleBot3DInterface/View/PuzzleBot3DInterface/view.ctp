		...
		<tr>
			...
			<td style="width: 20%; vertical-align:top;">
				<div id="instructions" style="height=500px; text-align: left; background-color:rgba(232, 238, 244, 1.0); border-radius:20px; margin:5px; padding:20px">
					<b>Move the arm</b> with the <b>ring and arrow marker</b> on the left.
					<br /><br /><b>Drag the arrows</b> to <b>translate</b> the arm, <b>drag the rings</b> to <b>rotate</b> the arm, <b>drag the background</b> to change the <b>camera angle</b>.
					<br /><br />Use the <b>Arm Controls</b> below to manipulate an object once you grasp it.
				</div>
			</td>
		</tr>
	</table>
		...
		<tr>
				...
				<table style="margin-left:auto;">
					<tr>
						<td style="vertical-align:middle;">
							<img src="/img/PuzzleBot3DInterface/nimbus-gripper.png" height="100" width="150" style="vertical-align:middle">
						</td>
						<td>
							<table>
								<tr>
									<td style="text-align:center" width="160px"><button id='openGripper' class='button special' style="width:170px">open gripper</button></td>
								</tr>
								<tr>
									<td style="text-align:center" width="160px"><button id='closeGripper' class='button special' style="width:170px">close gripper</button></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						<td style="vertical-align:middle;">
							<img src="/img/PuzzleBot3DInterface/nimbus-reset-arm.png" height="100" width="150" style="vertical-align:middle">
						</td>
						<td>
							<table>
								<tr>
			...
			<td>
				<table style="margin-left:auto; margin-right:auto;">
					<tr>
						<td style="vertical-align:middle;">
							<img src="/img/PuzzleBot3DInterface/nimbus-forward-back.png" height="100" width="150" style="vertical-align:middle">
						</td>
						<td>
							<table>
								<tr>
									<td style="text-align:center" width="160px"><button id='moveForward' class='button special' style="width:170px">move forward</button></td>
								</tr>
								<tr>
									<td style="text-align:center" width="160px"><button id='moveBack' class='button special' style="width:170px">move back</button></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						<td style="vertical-align:middle;">
							<img src="/img/PuzzleBot3DInterface/nimbus-left-right.png" height="100" width="150" style="vertical-align:middle">
						</td>
						<td>
							<table>
								<tr>
									<td style="text-align:center" width="160px"><button id='moveLeft' class='button special' style="width:170px">move left</button></td>
								</tr>
								<tr>
									<td style="text-align:center" width="160px"><button id='moveRight' class='button special' style="width:170px">move right</button></td>
								</tr>
							</table>
						</td>
					</tr>
			...
			<td>
				<table style="margin-right:auto;">
					<tr>
						<td style="vertical-align:middle;">
							<img src="/img/PuzzleBot3DInterface/nimbus-up-down.png" height="100" width="150" style="vertical-align:middle">
						</td>
						<td>
							<table>
								<tr>
									<td style="text-align:center" width="160px"><button id='moveUp' class='button special' style="width:170px">move up</button></td>
								</tr>
								<tr>
									<td style="text-align:center" width="160px"><button id='moveDown' class='button special' style="width:170px">move down</button></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						<td style="vertical-align:middle;">
							<img src="/img/PuzzleBot3DInterface/nimbus-rotate-wrist.png" height="100" width="150" style="vertical-align:middle">
						</td>
						<td>
							<table>
								<tr>
									<td style="text-align:center" width="160px"><button id='rotateCW' class='button special' style="width:170px">rotate cw</button></td>
								</tr>
								<tr>
									<td style="text-align:center" width="160px"><button id='rotateCCW' class='button special' style="width:170px">rotate ccw</button></td>
								</tr>
							</table>
						</td>
					</tr>
